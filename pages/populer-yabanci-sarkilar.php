...
$_title = 'Popüler Yabancı Şarkılar';

if( $cache = get_cache('popular_global_videos' , 3600 ) )
{
...
{	
	ob_start();
	$popular = curl('https://www.youtube.com/playlist?list=PLKhznRuMcfOZrq_5cDtzyLiEX5DoxCVpN');
	$videos  = array();
	...
	set_cache( 'popular_global_videos' , json_encode( $videos ) );
}
...
<div class="video-results">
	<h3 class="title">
		<i class="fab fa-youtube"></i> <span class="red">Youtube</span>'da Popüler Yabancı Şarkılar
