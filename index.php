...
$keywords = $_keywords ? $_keywords : $_config['keywords'];
$description = $_description ? $_description : $_config['description'];
...
box-shadow: 1px 1px 1px 0px rgba(0,0,0,0.34);}
	...
	@media( max-width: 800px )
	{
		...
		h3.title { font-size: 14px; margin: 10px; margin-bottom: 5px; display: block}
...
<body>
	...
	<div class="notice hide-mobile">
		<div class="container">
			...
			İstediğiniz youtube videosunu mp3 olarak veya direkt video olarak bilgisayarınıza telefonunuza kayıt edin, mp3 olarak indirin ve heryerde dinleyin.
		</div>
	</div>
	<div class="clear"></div>
